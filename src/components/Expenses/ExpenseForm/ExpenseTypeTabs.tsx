...
const ExpenseTypeTabs: React.FC<ExpenseTypeTabsProps> = ({
  ...
  // Main tabs that are always visible - limited to 5
  const mainTabs = [
  ...
  const moreOptions = [
    { type: 'professional_fees' as ExpenseType, label: 'Professional Fees' },
    { type: 'business_meals' as ExpenseType, label: 'Business Meals' },
    ...
    { type: 'other' as ExpenseType, label: 'Other' },
  ];
