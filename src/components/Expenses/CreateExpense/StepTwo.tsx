...
import { ArrowLeft, Check, Mic, Handshake, FileText, Coffee } from 'lucide-react';
    ...
    <div className="space-y-6 animate-fade-in">
        ...
        {watchMealsProvided === 'yes' && (
          <div className="space-y-3 pt-2 animate-fade-in">
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              >
                <Checkbox checked={watchMeals?.includes('breakfast')} />
              ...
              >
                <Checkbox checked={watchMeals?.includes('lunch')} />
              ...
              >
                <Checkbox checked={watchMeals?.includes('dinner')} />
      ...
      <div className="flex justify-between pt-2">
        ...
        <Button 
          ...
          onClick={onSubmit}
          size="sm"
          disabled={!watchTravelPurpose || (watchMealsProvided === 'yes' && (!watchMeals || watchMeals.length === 0))}
        >
          Create Expense
